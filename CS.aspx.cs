...
public partial class _Default : System.Web.UI.Page
{
    protected void GetWeatherInfo(object sender, EventArgs e)
    {
        ...
        string url = string.Format("http://api.openweathermap.org/data/2.5/forecast/daily?q={0}&units=metric&cnt=1&APPID=bd5e378503939ddaee76f12ad7a97608", txtCity.Text.Trim(), appId);
